...
class AppIcons {
  ...
  static const searchIcon = Icon(CupertinoIcons.search);
  static const sendIcon = Icon(Icons.send);
  static const storeIcon = Icon(Icons.storefront);
  static const ticketsIcon = Icon(CupertinoIcons.ticket);
  static const timeIcon = Icon(CupertinoIcons.time_solid);
}
